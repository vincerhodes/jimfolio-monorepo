...
CREATE TABLE "new_BrewLog" (
    ...
    CONSTRAINT "BrewLog_equipmentId_fkey" FOREIGN KEY ("equipmentId") REFERENCES "Equipment" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_BrewLog" ("beanId", "brewDate", "brewTimeSec", "createdAt", "doseG", "grindSetting", "grindSize", "grinder", "grinderId", "id", "methodId", "notes", "rating", "yieldG") SELECT "beanId", "brewDate", "brewTimeSec", "createdAt", "doseG", "grindSetting", "grindSize", "grinder", "grinderId", "id", "methodId", "notes", "rating", "yieldG" FROM "BrewLog";
DROP TABLE "BrewLog";
